...
function UpdateScript()
	if UPDATE_SCRIPT then
		local ServerData = GetWebResult(UPDATE_HOST, "/bolchallengers/bol/master/scripts/Challengers_Karthus.version")
		if ServerData then
...
function OnLoad()
	...
	-- Load Menu
	Menu = scriptConfig("Challengers Karthus", "Karthus")
